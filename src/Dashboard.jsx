...
const Dashboard = () => {
    ...
    const handleEditSubmit = async () => {
        try {
            await axios.put(`https://skillstackbyannmary.onrender.com/api/skills/${editingSkillId}/`, editFormData);
                        ...
                        <div className="skill-card" key={skill.id}>
                            {editingSkillId === skill.id ? (
                                ...
                                <>
                                    ...
                                    <p><strong>Type:</strong> {skill.resource_type}</p>
                                    <p><strong>Platform:</strong> {skill.platform}</p>
                                    <p><strong>Status:</strong> {skill.status}</p>
                                    <p><strong>Hours:</strong> {skill.hours_spent} / {skill.estimated_hours}</p>
